...
If you have done everything correctly, you should now be able to launch and use SAP&reg; on Linux. If you have any issues, please refer to the [installation guide](../installation/) or contact us via a [github issue](https://github.com/gamersi/howtosaplinux/issues/new).