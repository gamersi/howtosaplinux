...
- [SAP](https://www.sap.com/) for creating the ~~most user-unfriendly~~ best ERP system in the world
...
```
:::note[Info]
The installation will say it failed (with 4 errors), but that is just an error with links. The installation actually succeeded.
:::
